...
const MOOD_TAGS = [
  ...
  { label: 'فنتازيا', slug: 'فنتازيا' },
  { label: 'غموض', slug: 'غموض' },
  { label: 'رعب', slug: 'رعب' },
  { label: 'نفسي', slug: 'نفسي' },
  { label: 'اثارة', slug: 'اثارة' },
  { label: 'شريحة من الحياة', slug: 'شريحة-من-الحياة' },
  { label: 'قوى خارقة', slug: 'قوى-خارقة' },
  { label: 'خارق للعادة', slug: 'خارق-للعادة' },
  { label: 'سحر', slug: 'سحر' },
  { label: 'شياطين', slug: 'شياطين' },
  { label: 'مصاصي دماء', slug: 'مصاصي-دماء' },
  { label: 'فنون قتالية', slug: 'فنون-قتالية' },
  { label: 'ساموراي', slug: 'ساموراي' },
  { label: 'رياضي', slug: 'رياضي' },
  { label: 'مدرسي', slug: 'مدرسي' },
  { label: 'تاريخي', slug: 'تاريخي' },
  { label: 'حربي', slug: 'حربي' },
  { label: 'ميكا', slug: 'ميكا' },
  { label: 'فضائي', slug: 'فضائي' },
  { label: 'سيارات', slug: 'سيارات' },
  { label: 'موسيقي', slug: 'موسيقي' },
  { label: 'العاب', slug: 'العاب' },
  { label: 'محاكاة ساخرة', slug: 'محاكاة-ساخرة' },
  { label: 'أطفال', slug: 'أطفال' },
  { label: 'شونين', slug: 'شونين' },
  { label: 'سينين', slug: 'سينين' },
  { label: 'شوجو', slug: 'شوجو' },
  { label: 'جوسي', slug: 'جوسي' },
  { label: 'حريم', slug: 'حريم' },
  { label: 'جنون', slug: 'جنون' }
]
